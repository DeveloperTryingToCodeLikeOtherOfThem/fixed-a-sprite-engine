...
//% groups='["Gameplay", "Prompt"]' advanced=true
namespace game2 {
    /**
     ...
     */
    //% group="Gameplay"
    //% blockId=gameOver2 block="game over || %win=toggleWinLose with %effect effect"
    ...
    //% blockId=gameupdate2 block="on game update"
    ...
    //% blockId=gameinterval2 block="on game update every %period=timePicker ms"
    //% blockAllowMultiple=1
     ...
     */
    //% blockId=arcade_game_runtime2 block="time since start (ms)"
